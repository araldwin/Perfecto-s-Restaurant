...
now = timezone.now()
"""
creates a variable named now that stores the
current date and time in the timezone specified
by the Django project settings (usually the
timezone of the server running the Django application).
"""
